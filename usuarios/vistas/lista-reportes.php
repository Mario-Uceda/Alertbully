...
if (!isset($_SESSION['usuario']) || $_SERVER['REQUEST_URI'] == "/vistas/lista-reportes.php") {
    header("Location: /");
}
        ...
        <form class="formulario" method="POST">
            <div class="bloqueSelector">
                ...
                <select id="centroElegido" name="centroElegido">
                    ...
                    if($esAlumno) {
                        $centros = $consulta->getCentrosDeUsuario($_SESSION['id'], "alumno", 0);
                    }
    ...
    <script>
        $(document).ready(function() {
            $('select').on('change', function() {
                var parametros = "idcentro=" + $(this).val()
                $.ajax({
                    data: parametros,
                    url: '/buscador-reportes',
                    type: 'post',
                    beforeSend: function() {},
